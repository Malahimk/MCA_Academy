...
const ContactUs = () => {
    ...
    async function handleSubmission(event) {
        ...
        try {
            const request = await axios.post('https://mca-academy-backend-nine.vercel.app/api/sendEmail', data);
                        ...
                        >
                            <div className="subscription-box">
                                <div className="left">
                                    ...
                                    <br />
                                    <h5>Have a question or need more information? Please fill out the form and our team will get back to you shortly.</h5>
                                </div>
                                <div className="right">
