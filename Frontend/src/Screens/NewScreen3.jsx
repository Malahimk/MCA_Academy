                    ...
                    <Col xs={12} md={8} lg={8} xl={8}>
                        <motion.div initial="hidden" animate="show" variants={reveal("right", 0.3)}>
                            <div className="py-5">
                                ...
                                Marking a new chapter in delivering transformational learning designed <br />to prepare future leaders. This partnership aligns MCA Academy’s mission to drive <br /> regional growth with MySustainOnline’s expertise in sustainability training <br />and workforce empowerment. MySustainOnline provides scalable, expert-led, and  <br />customized learning solutions to help organizations integrate sustainability into <br />their business strategy.<br /> Together, we will equip professionals with the knowledge and skills needed to <br /> drive sustainable business transformation, develop leadership in green initiatives, <br /> and align  corporate practices with global sustainability goals.
                                </p>
                            </div>
                        </motion.div>
                    </Col>
