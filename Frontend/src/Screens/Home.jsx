...
const Home = () => {
  ...
  function PartnersSection() {
    ...
    const partners = [
      ...
      { imgSrc: '/images/isblogo.jpg', text: 'Transformational learning journeys designed to equip executives across business areas', link: 'https://execed.isb.edu/en.html' },
    ];
