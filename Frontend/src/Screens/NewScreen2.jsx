            ...
            <Container>
                <Row className="mt-5 bg-light py-4 rounded">
                    <Col xs={12} md={8} lg={8} xl={8}>
                        <motion.div initial="hidden" animate="show" variants={reveal("right", 0.3)}>
                            <div className="py-5">
                                ...
                                This collaboration brings a new focus on transformational learning to prepare future leaders, aligning MCA Academy’s mission to foster business growth with NWORX’s expertise in AI-powered career coaching and placement readiness. NWORX enhances employability by preparing individuals for professional success, improving placement outcomes, and equipping businesses with job-ready talent. Together, we will deliver high-impact training programs that bridge the gap between industry demand and workforce readiness, ensuring professionals excel in their careers.
                                </p>
                            </div>
                        </motion.div>
                    </Col>
                    <Col xs={12} md={4} lg={4} xl={4} className="d-flex justify-content-end align-items-center">
                        <img
                            src="/images/nvox2.PNG" // Replace with your image URL
                                ...
                                <Col xs={12} md={12} className='mt-3' style={{ display: 'flex' }}>
                                    ...
                                    >
                                        ...
                                        <ul className='card-list'>
                                            <li>AI-powered career coaching and mentoring for students and professional</li>
                                            <li>Enhances workforce performance with personalized, role-based preparation</li>
                                            <li>Seamless integration with enterprise and educational ecosystems</li>
                                        </ul>
                                    </motion.div>
                                </Col>
