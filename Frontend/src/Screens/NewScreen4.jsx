                    ...
                    <Col xs={12} md={8} lg={8} xl={8}>
                        <motion.div initial="hidden" animate="show" variants={reveal("right", 0.3)}>
                            <div className="py-5">
                                ...
                                Opening a new phase of transformational learning aimed at shaping future leaders,<br /> this collaboration supports MCA Academy’s goal of fostering business <br />growth through WeAce’s advanced digital coaching and mentoring platform. <br /> WeAce specializes in leadership development, career transition coaching, and well-being <br />support, leveraging AI-driven solutions to match professionals with expert mentors.  <br />Together, we will provide high-impact coaching programs that empower individuals and <br />organizations to foster continuous growth, resilience, and leadership excellence.
                                </p>
                            </div>
                        </motion.div>
                    </Col>
